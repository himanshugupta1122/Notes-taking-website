...
export default function AddPost() {
    ...
    return (
        <>
            <div>
                <input class="border-input2" type="text" placeholder='Enter Your Task' onChange={e => setTask(e.target.value)}></input>
              ...
              <button  class="  bg-white hover:bg-blue-300 p-3 m-3 rounded-full border border-blue-400"
   onClick={addTask} >
